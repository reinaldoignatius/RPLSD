...
//        ArrayList<ArrayList<Boolean>> availability = new ArrayList<>(Constants.DAYS_IN_A_WEEK);
//        for (int day = 0; day < Constants.DAYS_IN_A_WEEK; day++) {
//            availability.add(new ArrayList<>(Constants.HOURS_IN_A_DAY));
//            for (int time = 0; time < Constants.HOURS_IN_A_DAY; time++) {
//                availability.get(day).add(new Boolean(false));
//            }
//        }
        List<Pair<Integer, Integer>> availability = new ArrayList<>();
        availability.add(new Pair<>(0, 1));
        availability.add(new Pair<>(0, 2));

        List<Pair<Integer, Integer>> availability2 = new ArrayList<>();
        availability2.add(new Pair<>(0, 1));
        availability2.add(new Pair<>(0, 2));
...
//        availability.get(0).set(2, true);
        ...
        scheduler.addLecturer(new Lecturer("ayu", availability2));
